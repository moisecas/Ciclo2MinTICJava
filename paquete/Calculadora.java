...
public class Calculadora extends javax.swing.JFrame {
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        ...
        this.casilla.setText(this.casilla.getText()+"0");  //obtener valor de casilla 0 y así con los demás numeros
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        // suma
        this.primernumero=Float.parseFloat(this.casilla.getText());//asignado el primer numero tecleado a primernumero
        this.operador="+";
        this.casilla.setText(""); //limpiar casilla
    ...
    private void jButton20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton20ActionPerformed
        ...
        switch(this.operador){ //evaluamos el operador para mostrar un resultado
            case "+": this.casilla.setText(Float.toString(this.primernumero+this.segundonumero)); break;  //cuando sea + muestre la suma de los dos
            case "-": this.casilla.setText(Float.toString(this.primernumero-this.segundonumero)); break;
            case "*": this.casilla.setText(Float.toString(this.primernumero*this.segundonumero)); break;
            case "/": this.casilla.setText(Float.toString(this.primernumero/this.segundonumero)); break; //se agrega el break para dar paso a las otras opciones seleccionadas 
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        // opción . 
        if(!(this.casilla.getText().contains("."))){ //si no contiene . agregue . 
